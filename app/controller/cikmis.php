...
<div class="navbar navbar-dark bg-dark  navbar-expand-lg"  style=" width: 15%; float: left; min-height: 100vh !important; height: 100vh;  "><ul style="position:absolute; top:40px;">
...
<?php 
    ...
    if($a['cikmis_dersid']){
        ...
        echo '<li class="nav-item" style=""><a class="text-white nav-link"href='.url.'/cikmis/'.$cikmis_dersad[$i].'>'.$cikmis_dersad[$i] .'</a></li>';
...
<br><br>
<div class="cikmis-soru"  style="background-color: red; margin-left: 20%; margin-right: 20%; "> <ul >
<?php 
 $k=0;
